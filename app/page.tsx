    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8 pb-8 border-b border-zinc-800/80">
      <div className="space-y-3">
        <p className="text-sm text-zinc-400 leading-relaxed max-w-sm">
          เว็บไซต์รวบรวมและแนะนำสเปกสมาร์ทโฟนและแท็บเล็ต เพื่อช่วยให้คุณเลือกซื้อเครื่องที่คุ้มค่าและตอบโจทย์การใช้งานมากที่สุด คำชี้เเจง ข้อมูลต่าง และ คำอธิบายเว็บไซต์นี้อาจผิดพลาดได้ คุณสามารถค้นหามือถือรุ่นใดๆท่่คุณสนใจเพิ่มเติมได้ผ่านแพลตฟอร์ม GSMArena Droidsans และอื่นๆเพิ่มเติม
        </p>
      </div>
