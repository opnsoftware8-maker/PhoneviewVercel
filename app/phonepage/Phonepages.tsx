...
export default function Phonepage({
  ...
  <a
    ...
    className="block w-full text-center bg-orange-500 hover:bg-orange-700 border border-orange-800 transition py-2 rounded-xl font-bold text-sm text-zinc-300"
  >
