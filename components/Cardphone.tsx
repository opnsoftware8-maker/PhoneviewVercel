...
export function Phonecard({ Device }: { Device: any }) {
  ...
  return (
    ...
    <div className="w-full max-w-sm h-[250px] flex flex-col overflow-hidden border-[2px] border-zinc-300 rounded-xl p-4 bg-white transition-all duration-300 ease-in-out hover:-translate-y-1.5 hover:shadow-xl hover:border-zinc-500">
      ...
      <div className="mt-auto w-full pt-2">
        ...
        <div className="flex items-center justify-between gap-3">
          ...
          <button className="font-prompt whitespace-nowrap bg-black font-bold h-10 text-white px-4 rounded-[12px] flex items-center justify-center shrink-0 transition-all duration-200 hover:scale-105 hover:bg-zinc-800 active:bg-zinc-700/90 active:scale-95 shadow-md">
            สำรวจสเปค
          </button>
        </div>
      </div>
