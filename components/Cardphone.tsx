...
export function Phonecard({ Device, PropCard }: PhoneCardProps) {
  ...
  return (
    <div className="w-full h-[190px] flex flex-col overflow-hidden border-2 border-zinc-200 rounded-2xl p-4 bg-white transition-all duration-200 ease-out hover:-translate-y-1 hover:shadow-lg hover:border-zinc-400">
