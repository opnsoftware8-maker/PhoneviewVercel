...
export function Phonecard({ Device }: { Device: any }) {
  ...
  return (
    ...
    <div className="w-full max-w-sm h-[260px] flex flex-col overflow-hidden border-[2px] border-zinc-300 rounded-xl p-4 bg-white transition-all duration-300 ease-in-out hover:-translate-y-1.5 hover:shadow-xl hover:border-zinc-500">
