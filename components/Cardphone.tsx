...
export function Phonecard({ Device, PropCard }: { Device: any, PropCard: (name: string) => void }) {
  ...
  return (
    ...
    <div className="w-full h-240 flex flex-col justify-between border-2 border-zinc-200 rounded-2xl p-4 bg-white transition-all duration-200 ease-out hover:-translate-y-1 hover:shadow-lg hover:border-zinc-400">
