...
export function Phonecard({ Device, PropCard }: PhoneCardProps) {
  ...
  return (
    <div className="w-full sm:h-[180px] md:h-[180px] flex flex-col overflow-hidden border-2 border-zinc-200 rounded-2xl p-4 bg-white transition-all duration-200 ease-out hover:-translate-y-1 hover:shadow-lg hover:border-zinc-400">
  ...
  <div className="flex-1 min-h-0 overflow-y-auto no-scrollbar flex flex-col mt-2">
    ...
    <div
      ...
      className="group relative w-full py-1 text-xs font-prompt text-zinc-600 no-scrollbar overflow-x-auto whitespace-nowrap"
      style={{
        scrollbarWidth: "none",
    ...
    >
      ...
      <div className="spec-scroll inline-flex gap-x-3">
    ...
    <div
      onWheel={handleWheelScroll}
      className="group relative w-full py-1 mt-1 font-prompt no-scrollbar overflow-x-auto whitespace-nowrap"
      style={{
        scrollbarWidth: "none",
        WebkitOverflowScrolling: "touch",
      }}
    >
      ...
      <div className="tags-scroll inline-flex gap-1.5">
