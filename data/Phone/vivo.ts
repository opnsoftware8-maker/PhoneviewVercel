...
},
{
  ...
  shopee: "https://th.shp.ee/TRW8Hash",
    ...
    camera: {
      main: 50,
      selfie: 32,
      video: "รองรับถ่ายวิดีโอ 4K ทั้งกล้องหน้าและกล้องหลัง",
      ois: false,
      digitalZoom: 0,
    },
    storageRam: [],
    display: "จอ FHD+ 120Hz, สว่างสูงสุด 1200 nits, LCD",
    battery: 7200,
    charge: {
      wired: 44,
      wireless: 0,
    ...
    pros: [
      "แบต 7200mAh อึดมาก เหมาะกับสายใช้งานยาว ๆ และคนที่ไม่อยากชาร์จบ่อย",
      "ชาร์จ 44W ใช้งานจริงสะดวกสำหรับคนที่ต้องรีบเติมแบตระหว่างวัน",
      "ชิป Dimensity 7400-Turbo เหมาะกับสายลื่นไหล มัลติทาสก์ และเกมระดับกลาง",
      "จอ 120Hz ช่วยให้การเลื่อนหน้าจอและเล่นเกมดูสมูท",
      "ได้มาตรฐาน IP68/IP69+ เหมาะกับคนที่ต้องการความทนทานสูง",
      "ถนัดสายแบตอึด เกมทั่วไป งานประจำวัน และใช้งานทน ๆ",
    ],
    cons: [
      "กล้องไม่ได้เด่นสุดสำหรับสายถ่ายภาพจริงจัง",
      "ไม่มีชาร์จไร้สาย",
      "ไม่ใช่รุ่นที่เน้นกล้องหรือความพรีเมียมระดับบนสุด",
      "ไม่ค่อยถนัดสายคอนเทนต์ภาพนิ่งหรือวิดีโอที่ต้องการฮาร์ดแวร์กล้องจัดเต็ม",
    ],
    official: "https://www.iqoo.com/th/products/z11x",
    shopee: "https://th.shp.ee/f7qAm134",
},
